...
VALUES
  ('en', 'nav_section_studies', 'Studies'),
  ('en', 'nav_section_experience', 'Experience'),
  ('en', 'nav_section_friends', 'Friends'),
  (
    'en',
    'nav_languages',
  ...
  ('en', 'active_language_iso', 'EN'),
  ('en', 'nav_collapsed_title_language', 'Switch Language'),
  ('en', 'home_heading', 'Hello, World!'),
  (
    'en',
    'home_intro',
  ...
  ('en', 'experience_heading', 'The work I have done'),
  (
    'en',
    'experience_hey_description',
  ...
  (
    'en',
    'experience_nvim_conda_description',
  ...
  ('en', 'friends_heading', 'Company & Devotion'),
  (
    'en',
    'friends_intro',
  ...
  ('es', 'nav_section_studies', 'Estudios'),
  ('es', 'nav_section_experience', 'Experiencia'),
  ('es', 'nav_section_friends', 'Amigos'),
  (
    'es',
    'nav_languages',
  ...
  ('es', 'active_language_iso', 'ES'),
  ('es', 'nav_collapsed_title_language', 'Cambiar Idioma'),
  ('es', 'home_heading', 'Aló'),
  (
    'es',
    'home_intro',
  ...
  ('es', 'experience_heading', 'Mi trabajo'),
  (
    'es',
    'experience_hey_description',
  ...
  ('es', 'friends_heading', 'Querida Compañía'),
  (
    'es',
    'friends_intro',
